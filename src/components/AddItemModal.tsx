...
import { X, ImagePlus, Camera, ChevronDown, Search, Sparkles, Database, Loader2, Trash2, ChevronLeft, Save } from "lucide-react";
...
export default function AddItemModal({ isOpen, onClose, onAdd }: AddItemModalProps) {
  ...
  const handleSelectSuggestion = (item: MasterItem) => {
    ...
    if (item.category === "Trading Cards" || item.category === "Pokémon TCG") setCategory("Trading Cards");
                  ...
                  >
                    <div className="flex items-center gap-3 px-4 py-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-cream/25 mt-0.5">PNG, JPG up to 5 MB</p>
                      </div>
                    </div>
                  </div>
                )}
          ...
          <>
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-white/[0.06] flex-shrink-0">
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                {(customImage || catalogImage) && (
                  <img
                    src={customImage || catalogImage || ""}
                    alt=""
