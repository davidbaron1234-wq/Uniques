...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col items-center justify-center px-4 py-8 sm:py-12">
      {/* Background glow */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-primary/10 blur-[120px] rounded-full" />
        <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-surface/10 blur-[100px] rounded-full" />
      </div>
      ...
      <div className="relative w-full max-w-sm space-y-8">
        ...
        <div className="glass border border-white/[0.08] rounded-3xl p-6 space-y-5 shadow-2xl">
          ...
          {/* Google OAuth button + legal disclaimer */}
